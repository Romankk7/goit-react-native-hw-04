...
<View style={ styles.postContainer }>
   ...
   <View style={ styles.postForm }>
      <TextInput style={ styles.postName } placeholder="Название..." inputMode="text" />
      <TextInput style={ styles.postName } placeholder="Местность..." inputMode="navigation"/>
    ...
    return (
        <BottomTabs.Navigator screenOptions={{
            ...
            <BottomTabs.Screen 
                ...
                }} name='Создать публикацию' component={CreatePost}/>
